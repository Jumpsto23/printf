 ...
 * @size: Size specifier
 *
 * Return: On success (Number of chars printed.)
 */
 ...
 * @extra_c: Extra char
 *
 * Return: On success (Number of printed chars.)
 */
 ...
 * @size: Size specifier
 *
 * Return: On success (Number of written chars.)
 */
 ...
 * @padd_start: Index of starting point fo padding
 *
 * Return: On success (Number of written chars.)
 */
